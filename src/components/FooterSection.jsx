        ...
        <footer className="footer">
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:pt-32 2xl:max-w-400">
                ...
                <div className="mt-16 grid grid-cols-2 gap-8 md:grid-cols-4">
                    ...
                    {/* shop column - built by looping over the navigation.shop array */}
                    ...
                    {/* support column - delay 0.3 = reveal just after company */}
                ...
                <div className="footer-bottom">
                    <p>&copy; {currentYear} The Beans Place. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
